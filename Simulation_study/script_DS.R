...
# Running GCPBayes 
    for(g in 1:G){
        ...
        list_sigmah <- list(SIGMA[[1]][Group==g,Group==g],SIGMA[[2]][Group==g,Group==g])
...
# SAVE
write.table(res_summary_table, file=paste0(outputdir,"simu_res_ds_short.txt"), quote = FALSE)
write.table(Finaltime, file=paste0(outputdir,"time_ds_short.txt"), quote = FALSE)
