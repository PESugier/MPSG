...
# SAVE
write.table(res_summary_table, file=paste0(outputdir,"simu_res_ds_short_diag.txt"), quote = FALSE)
write.table(Finaltime, file=paste0(outputdir,"time_ds_short_diag.txt"), quote = FALSE)
