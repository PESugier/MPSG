...
# SAVE
write.table(res_summary_table, file=paste0(outputdir,"simu_res_metapsg_adapt.txt"), quote = FALSE)
write.table(Finaltime, file=paste0(outputdir,"time_metapsg_adapt.txt"), quote = FALSE)
